...
const TopPartner: FC = () =>{
    ...
    var items = [
        ...
        },
        {
            ...
            description: "Hello World!",
            image: "https://1000logos.net/wp-content/uploads/2022/09/Anytime-Fitness-logo.png",
        },
    ]
    var items2 = [
        {
            ...
            description: "Probably the most random thing you have ever seen!",
            image: "https://cdn.join.com/61bce2758f0b6900092d4a68/teleperformance-egypt-logo-xl.png",
        },
        {
            name: "Eureka outsourcing",
            description: "Hello World!",
            image: "https://res.cloudinary.com/interviewair/image/upload/w_200,h_200,c_pad,b_white/v1464258677/wqkmfcsie3yfz1iadf6e.jpg",
        },
        {
            name: "Conneqt",
            description: "Hello World!",
            image: "https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/ixaawpwhqa6qqnat8j8c",
        }
    ]
    var items3 = [
        {
    ...
    function Item(props: any)
    {
        return (
            <Paper>
                <img style={{'width': '200px', 'height': '150px','margin': '0 15%'}} src={props.item.image} />
    ...
    <div className="carousel-container">
        <Carousel
            ...
            >
                {
                    items3.map( (item, i) =>   <Item key={i} item={item} /> )
                }
